...
const ProfilePage = () => {
  ...
  function handleProfileUpdate(e) {
    ...
    if (image.length === 0) {
      axios
        .patch("https://miniproject2backend.onrender.com/updateprofile", {
          userid: id,
  ...
  return (
    <>
      ...
      <section className="bg-gray-900">
        <div className="grid grid-rows-2 p-8">
          <div className="bg-gray-800 m-5 rounded-2xl p-4 grid grid-cols-8">
            <div className="grid place-items-center col-span-2">
              {userStore.user?.profile_image ? (
                <img
                  ...
                  alt="..."
                  className={"border-4 border-white rounded-full h-32 w-32"}
                />
              ) : null}
            </div>

            <div className="col-span-5">
              <p className="font-semibold tracking-wide text-4xl mt-4 text-white">
                {username}
              </p>

              <p className="font-medium text-2xl mt-4 capitalize text-gray-100">
                {userStore.user.role}
              </p>

              <div className="mt-4">
                <p className="font-medium text-2xl mt-4 capitalize text-gray-300 hover:text-gray-100 inline">
                  VID :{" "}
                </p>

                <p
                  className="font-medium text-2xl mt-4 mr-2 capitalize text-gray-300 hover:text-gray-100 inline"
                  ref={vidHiddenRef}
                >
                  XXXX XXXX {userStore.user?.vid?.substring(8, 12)}
                </p>

                <p
                  className="hidden font-medium text-2xl mt-5 capitalize text-gray-300 hover:text-gray-100 mr-2 inline"
                  ref={vidRef}
                >
                  {userStore.user?.vid?.substring(0, 4)}{" "}
                  {userStore.user?.vid?.substring(4, 8)}{" "}
                  {userStore.user?.vid?.substring(8, 12)}
                </p>
                ...
                {isVisible ? (
                  <>
                    <button
                      onClick={toggleVID}
                      className="invert text-lg inline"
                    >
                      <AiFillEyeInvisible />
                    </button>
                  </>
            ...
            <div className="">
              <button
                className="rounded hover:shadow-[0_8px_9px_-4px_rgba(84,180,211,0.3),0_4px_18px_0_rgba(84,180,211,0.2)]"
                onClick={toggleModal}
              >
                <img
                  src="https://www.svgrepo.com/show/502640/edit-1.svg"
                  className="invert h-10 bg-transparent "
                  alt="..."
                />
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 m-5">
            <div className="bg-gray-800 rounded-2xl p-4">
              ...
              <div className={"mb-2"}>
                <label>
                  <img
                    src="https://www.svgrepo.com/show/435312/email.svg"
                    className="h-7 inline invert"
                    alt={"...."}
                  />
                </label>
              ...
              <div className={"mb-2"}>
                <label>
                  <img
                    src="https://www.svgrepo.com/show/511585/call-191.svg"
                    className="h-7 inline invert"
                    alt={"..."}
                  />
                </label>
                <span className="ml-2 text-lg text-white">
                  +91-{userStore.user.phone}
                </span>
              </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-4">
              ...
              <div className="mb-2">
                <label>
                  <img
                    src="https://www.svgrepo.com/show/308274/government-building-building-museum-power.svg"
                    className={"inline h-7 invert"}
                    alt="..."
                  />
                </label>
                <span className={"ml-2 text-lg text-white"}>
      ...
      <div
        className="bg-black bg-opacity-50 absolute top-4 inset-0 justify-center items-center px-6 py-3 text-white rounded shadow hidden"
        ref={overlayRef}
      >
        <div className="bg-gray-800 py-2 px-3 rounded shadow-xl text-white w-[70%]">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-4xl font-bold">Update Details</h4>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-6 h-6 cursor-pointer p-1 hover:bg-gray-300 rounded-full"
              onClick={toggleModal}
            >
              <path
                strokeLinecap="round"
                ...
                <div className="grid place-items-center col-span-full">
                  {showImage ? (
                    <img
                      ...
                      alt="..."
                      className={
                        "cursor-pointer border-4 border-white rounded-full h-32 w-32"
                      }
                      onClick={() => {
          ...
          <div className={"mt-3 flex justify-end space-x-3"}>
            <button
              className="px-3 py-1 rounded hover:bg-red-600 hover:bg-opacity-50 hover:text-red-100"
              onClick={toggleModal}
            >
              Cancel
            </button>
            <button
              className="px-3 py-1 bg-red-800 text-gray-200 rounded hover:bg-red-600"
